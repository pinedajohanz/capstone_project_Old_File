...
function SeeResPersoInfo() {
  ...
  return (
    ...
    {PersoInfo.map(Info => (
      <div className="col border border-success my-4">
                <div className="card-body p-4">
                  ...
                  <div className="row pt-1">
                    <div className="col-6 mb-3">
                      <h5>User ID#</h5>
                      <p className="text-body">{Info.resident_id} </p>
                    </div>
                    <div className="col-6 mb-3">
                      <h5>First Name</h5>
                      <p className="text-body">{Info.first_name} </p>
                    </div>
                  </div>
                  ...
                  <div className="row pt-1">
                    <div className="col-6 mb-3">
                      ...
                      <p className="text-body">{Info.middle_init} </p>
                    </div>
                    <div className="col-6 mb-3">
                      <h5>Last Name</h5>
                      <p className="text-body">{Info.last_name} </p>
                    </div>
                  </div>
                  <hr className="mt-0 mb-4" />
                  <div className="row pt-1">
                    <div className="col-6 mb-3">
                      <h5>Birthday</h5>
                      <p className="text-body">{Info.birthday} </p>
                    </div>
                    <div className="col-6 mb-3">
                      <h5>Contact Number</h5>
                      <p className="text-body">{Info.contact_number} </p>
                    </div>
                  </div>
                  <hr className="mt-0 mb-4" />
                  <div className="row pt-1">
                    <div className="col-6 mb-3">
                      <h5>Subdivision</h5>
                      <p className="text-body">{Info.subdivision_address} </p>
                    </div>
                    <div className="col-6 mb-3">
                      <h5>House Street</h5>
                      <p className="text-body">{Info.house_street_address} </p>
                    </div>
                  </div>
                  <hr className="mt-0 mb-4" />
                  <div className="row pt-1">
                    <div className="col-6 mb-3">
                      <h5>Email</h5>
                      <p className="text-body">{Info.email_address} </p>
                    </div>
                    <div className="col-6 mb-3">
                      <h5>Username</h5>
                      <p className="text-body">{Info.username} </p>
                    </div>
                  </div>
                </div>
        </div>
